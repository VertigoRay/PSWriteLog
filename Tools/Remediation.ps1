...
if (Get-Module 'PSWriteLog' -ListAvailable) {
    ...
    Get-Module 'PSWriteLog' -ListAvailable | Where-Object {
        # Where versions are less than the current version installed ...
        $_.Version -lt ((Find-Module 'PSWriteLog' -ErrorAction 'Ignore').Version | Sort-Object -Descending | Select-Object -First 1)
    } | Foreach-Object {
